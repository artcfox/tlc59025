...
# ATtiny85 - Remove clock divider, set PLL Clock, enable clock output, Preserve EEPROM
#FUSES      = -U hfuse:w:0xd7:m -U lfuse:w:0xa1:m
# ATtiny85 - Remove clock divider, set PLL Clock, enable clock output, BOD 2.7 V
#FUSES      = -U hfuse:w:0xdd:m -U lfuse:w:0xa1:m
# ATtiny85 - Remove clock divider, set PLL Clock, enable clock output, Preserve EEPROM, BOD 4.3 V
#FUSES      = -U hfuse:w:0xd4:m -U lfuse:w:0xa1:m
...
LDFLAGS = -lc -lm
OBJECTS = main.o tlc59025.o tlc59025+display_module.o
...
read_flash:
	$(AVRDUDE) -U flash:r:main.bin:r

read_eeprom:
	$(AVRDUDE) -U eeprom:r:main.eep:r
